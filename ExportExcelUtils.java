...
public class ExportExcelUtils {
    ...
    private static final Logger logger = Logger.getLogger(ExportExcelUtils.class);
...
//        response.reset();//会清除session，导致session丢失
        ...
        try {
            ...
            for(String value : fieldMap.values()){
                sheet.setColumnWidth(i++, value.getBytes().length*256+184);
            }
